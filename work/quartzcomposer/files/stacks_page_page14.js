...
// Javascript for stacks_in_541_page14
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_541_page14 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_541_page14 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='centered',baseColor='#333333',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive=''==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_541_page14 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_541_page14 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_541_page14 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_541_page14 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_541_page14 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_541_page14 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
...
// Javascript for stacks_in_2921_page14
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_2921_page14 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_2921_page14 = (function(stack) {
...
// Javascript for stacks_in_16691_page14
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_16691_page14 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_16691_page14 = (function(stack) {
...
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_16691_page14, .open_stacks_in_16691_page14, .slidethingTrigger_stacks_in_16691_page14, #slidethingContainer_stacks_in_16691_page14 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_16691_page14").slideToggle(600);
	});
});
...
// Javascript for stacks_in_15921_page14
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_15921_page14 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_15921_page14 = (function(stack) {
...
var $timelinething = jQuery.noConflict();
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_15921_page14, .open_stacks_in_15921_page14, .slidethingTrigger_stacks_in_15921_page14, #slidethingContainer_stacks_in_15921_page14 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_15921_page14").slideToggle(600);
	});
});
