...
// Javascript for stacks_in_1_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_1_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_1_page43 = (function(stack) {
...
// Javascript for stacks_in_6944_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_6944_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_6944_page43 = (function(stack) {
...
// Javascript for stacks_in_15027_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_15027_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_15027_page43 = (function(stack) {
 ...
 var opacity=100,opacityBottom=85,hoverOpacity=15,subNavIndex=1,divide=0,zoneDivider=0,fullWidthMenu='',scope='all',style='solid',menuAlign='centered',baseColor='#FFFFFF',baseColorTop='#737373',hoverColor='#FFFFFF',styleActive=''==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,menuItems='#stacks_in_15027_page43 ul:not(.title-area) li:hover:not(.has-dropdown) > a:not(.button)',dropdowns='#stacks_in_15027_page43 ul:not(.title-area) li.has-dropdown';if(opacity<100||style=="faded"){$.glass({colors:[baseColor,baseColorTop],gradient:style,opacity:[opacity,opacityBottom],selector:'#stacks_in_15027_page43 .top-bar-wrapper'});$.glass({colors:[baseColor],opacity:[opacity],selector:'#stacks_in_15027_page43 ul:not(.title-area) ul.dropdown'});}
if(hoverOpacity<100){if(styleActive){var active=magellan?'#stacks_in_15027_page43 .top-bar-wrapper.styleActive .magellanList li.active > a':'#stacks_in_15027_page43 .top-bar-wrapper.styleActive li.active > a';$.glass({colors:[hoverColor],opacity:[hoverOpacity],selector:active});}
...
$(document).ready(function(){var stack=$('#stacks_in_15027_page43');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
...
// Javascript for stacks_in_11448_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_11448_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_11448_page43 = (function(stack) {
...
// Javascript for stacks_in_13258_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_13258_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_13258_page43 = (function(stack) {
 ...
 $(document).ready(function(){var movingbox=$('#stacks_in_13258_page43 >.movingbox'),effect='slide',fade=(effect=='fade')?true:false,vertical=(effect=='slide-vert')?true:false,initial=1-1,sync=0,autoplay=true,b1conf={breakpoint:480,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},b2conf={breakpoint:660,settings:{slidesToShow:(effect=='fade')?1:1,slidesToScroll:1,initialSlide:1-1,centerMode:false,centerPadding:'%',dots:true,arrows:false}},breakpoints=[];if(window.debug===true)autoplay=false;var slideTitles=[];movingbox.children().each(function(index){var title=index+1;var headers=$(this).find('h1,h2,h3,h4,h5,h6');if(headers.exists()){$.debug('Slide Headers',headers);title=headers.first().text().replace(/\s+/g,'-').toLowerCase();}
else{var images=$(this).find('img');if(images.exists()){$.debug('Slide Images',images);alt=images.first().attr('alt').replace(/\s+/g,'-').toLowerCase();title=alt!==''?alt:title;}}
$.debug('Slide Title #'+index+':'+title);slideTitles.push(title);});$.debug('All Slide Titles:',slideTitles);if(true)breakpoints.push(b1conf);if(false)breakpoints.push(b2conf);if(false){$('>.stacks_out',movingbox).each(function(){$(this).width($(this).width());});}
...
// Javascript for stacks_in_12574_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_12574_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_12574_page43 = (function(stack) {
...
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_12574_page43, .open_stacks_in_12574_page43, .slidethingTrigger_stacks_in_12574_page43, #slidethingContainer_stacks_in_12574_page43 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_12574_page43").slideToggle(600);
	});
});
...
// Javascript for stacks_in_12621_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_12621_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_12621_page43 = (function(stack) {
...
var $timelinething = jQuery.noConflict();
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_12621_page43, .open_stacks_in_12621_page43, .slidethingTrigger_stacks_in_12621_page43, #slidethingContainer_stacks_in_12621_page43 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_12621_page43").slideToggle(600);
	});
});
...
// Javascript for stacks_in_12806_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_12806_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_12806_page43 = (function(stack) {
...
var $timelinething = jQuery.noConflict();
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_12806_page43, .open_stacks_in_12806_page43, .slidethingTrigger_stacks_in_12806_page43, #slidethingContainer_stacks_in_12806_page43 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_12806_page43").slideToggle(600);
	});
});
...
// Javascript for stacks_in_12694_page43
// ---------------------------------------------------------------------

// Each stack has its own object with its own namespace.  The name of
// that object is the same as the stack's id.
stacks.stacks_in_12694_page43 = {};

// A closure is defined and assigned to the stack's object.  The object
// is also passed in as 'stack' which gives you a shorthand for referring
// to this object from elsewhere.
stacks.stacks_in_12694_page43 = (function(stack) {
...
var $timelinething = jQuery.noConflict();
$timelinething(document).ready(function(){
	$timelinething("#slidethingTrigger_stacks_in_12694_page43, .open_stacks_in_12694_page43, .slidethingTrigger_stacks_in_12694_page43, #slidethingContainer_stacks_in_12694_page43 .slidethingButton").click(function(){
		$timelinething("#slidethingContainer_stacks_in_12694_page43").slideToggle(600);
	});
});
